 ...
 * It deletes or moves the /src and /scripts directories to /example based on user input and creates a new /src/app directory with an index.js and _layout.js file.
...
const moveDirectories = async (userInput) => {
  try {
    ...
    console.log("📄 src/app/_layout.js created.");
